...
async def help(ctx):
	...
	em.add_field(name='Moderation', value = 'ban, kick, mute, clear, prefix')
...
async def prefix(ctx):
	em = discord.Embed(title = '.prefix', description='Изменить префикс бота на сервере', color = ctx.author.color)

	em.add_field(name = '*Syntax*', value = '.prefix `новый префикс`')
...
bot.run('MTAxMTM0ODc0MDM2OTU1OTYwMw.GCOEbP.jAap_V_zH_GBove8P3amBYjVVsLd5nY8laHomg')
